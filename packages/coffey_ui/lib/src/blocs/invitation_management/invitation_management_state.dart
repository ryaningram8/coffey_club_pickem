...
class InvitationManagementState with _$InvitationManagementState {
  const factory InvitationManagementState.initial() =
      InvitationManagementInitial;
  const factory InvitationManagementState.loading() =
      InvitationManagementLoading;

  /// No pools/seasons exist at all yet.
  const factory InvitationManagementState.noSeasons() =
      InvitationManagementNoSeasons;
